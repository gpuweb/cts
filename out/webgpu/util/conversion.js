...
export const TypeAbstractInt = new ScalarType(
  'abstract-int',
  8,
  (buf, offset) => abstractInt(valueFromBytes(workingDataI64, buf, offset))
);
...
const kFloatScalars = [TypeAbstractFloat, TypeF32, TypeF16];
...
export const kConvertableToFloatScalar = [TypeAbstractInt, ...kFloatScalars];

/// All types which are convertable to floating-point vector 2 types.
export const kConvertableToFloatVec2 = [TypeVec(2, TypeAbstractInt), ...kFloatVec2];

/// All types which are convertable to floating-point vector 3 types.
export const kConvertableToFloatVec3 = [TypeVec(3, TypeAbstractInt), ...kFloatVec3];

/// All types which are convertable to floating-point vector 4 types.
export const kConvertableToFloatVec4 = [TypeVec(4, TypeAbstractInt), ...kFloatVec4];
