...
**/import { kValue } from '../../../../util/constants.js';import { FP } from '../../../../util/floating_point.js';import { sparseScalarF64Range } from '../../../../util/math.js';
...
export const kSubtractionRawValues = [
...
{ lhs: kValue.f64.negative.max, rhs: kValue.f64.negative.subnormal.min, expected: [kValue.f64.negative.max, kValue.f64.negative.subnormal.max, 0.0] },
{ lhs: kValue.f64.negative.max, rhs: kValue.f64.negative.subnormal.max, expected: [kValue.f64.negative.max, kValue.f64.negative.subnormal.min, 0.0] },
{ lhs: kValue.f64.negative.max, rhs: 0.0, expected: [kValue.f64.negative.max] },
{ lhs: kValue.f64.negative.max, rhs: kValue.f64.positive.subnormal.min, expected: [reinterpretU64AsF64(0x8010000000000001n) /* ~-2.22507e-308 */, kValue.f64.negative.max, 0.0] },
{ lhs: kValue.f64.negative.max, rhs: kValue.f64.positive.subnormal.max, expected: [reinterpretU64AsF64(0x801fffffffffffffn) /* ~-4.45015e-308 */, kValue.f64.negative.max, 0.0] },
...
{ lhs: kValue.f64.positive.min, rhs: kValue.f64.negative.subnormal.min, expected: [0.0, kValue.f64.positive.min, reinterpretU64AsF64(0x001fffffffffffffn) /* ~4.45015e-308 */] },
{ lhs: kValue.f64.positive.min, rhs: kValue.f64.negative.subnormal.max, expected: [0.0, kValue.f64.positive.min, reinterpretU64AsF64(0x0010000000000001n) /* ~2.22507e-308 */] },
{ lhs: kValue.f64.positive.min, rhs: 0.0, expected: [kValue.f64.positive.min] },
{ lhs: kValue.f64.positive.min, rhs: kValue.f64.positive.subnormal.min, expected: [0.0, kValue.f64.positive.subnormal.max, kValue.f64.positive.min] },
{ lhs: kValue.f64.positive.min, rhs: kValue.f64.positive.subnormal.max, expected: [0.0, kValue.f64.positive.subnormal.min, kValue.f64.positive.min] },
...
const kSubtractionTable = Object.fromEntries(
