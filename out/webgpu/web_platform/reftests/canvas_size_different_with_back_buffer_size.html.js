...
**/import { assert } from '../../../common/util/util.js';import { runRefTest } from './gpu_ref_test.js';
...
export function run() {
  runRefTest(async (t) => {
    ...
    function setRowColors(data, offset, colors) {
...
//# sourceMappingURL=canvas_size_different_with_back_buffer_size.html.js.map