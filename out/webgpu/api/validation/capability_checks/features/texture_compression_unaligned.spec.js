...
import {
  ...
  getRequiredFeatureForTextureFormat } from
'../../../../format_info.js';
import { UniqueFeaturesOrLimitsGPUTest } from '../../../../gpu_test.js';

export const g = makeTestGroup(UniqueFeaturesOrLimitsGPUTest);

const kTextureCompressionUnaligned = 'texture-compression-unaligned';
...
.combine('sizeCase', ['width', 'height', 'both', 'single'])
).
beforeAllSubcases((t) => {
...
//# sourceMappingURL=texture_compression_unaligned.spec.js.map