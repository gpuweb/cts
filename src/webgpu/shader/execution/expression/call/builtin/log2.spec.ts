...
import { log2Interval, log2LargestIntermediateValue } from '../../../../../util/f32_interval.js';
...
export const d = makeCaseCache('log2', {
  f32_const: () => {
    return generateUnaryToF32IntervalCases(inputs, [log2Interval], log2LargestIntermediateValue);
  },
  f32_non_const: () => {
    return generateUnaryToF32IntervalCases(inputs, [log2Interval]);
  },
});
