...
import {
  normalizeInterval,
  normalizeLargestIntermediateValue,
} from '../../../../../util/f32_interval.js';
import { vectorF32Range } from '../../../../../util/math.js';
import { makeCaseCache } from '../../case_cache.js';
import { allInputSources, generateVectorToVectorIntervalCases, run } from '../../expression.js';
...
export const d = makeCaseCache('normalize', {
  f32_vec2_const: () => {
    return generateVectorToVectorIntervalCases(
      vectorF32Range(2),
      normalizeInterval,
      normalizeLargestIntermediateValue
    );
  ...
  f32_vec2_non_const: () => {
    return generateVectorToVectorIntervalCases(vectorF32Range(2), normalizeInterval);
  },
  f32_vec3_const: () => {
    return generateVectorToVectorIntervalCases(
      vectorF32Range(3),
  ...
  f32_vec3_non_const: () => {
    return generateVectorToVectorIntervalCases(vectorF32Range(3), normalizeInterval);
  },
  f32_vec4_const: () => {
    return generateVectorToVectorIntervalCases(
      vectorF32Range(4),
  ...
  f32_vec4_non_const: () => {
    return generateVectorToVectorIntervalCases(vectorF32Range(4), normalizeInterval);
  },
});
