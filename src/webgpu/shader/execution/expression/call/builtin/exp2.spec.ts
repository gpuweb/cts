...
import { exp2Interval, exp2LargestIntermediateValue } from '../../../../../util/f32_interval.js';
...
export const d = makeCaseCache('exp2', {
  f32_const: () => {
    return generateUnaryToF32IntervalCases(inputs, [exp2Interval], exp2LargestIntermediateValue);
  },
  f32_non_const: () => {
    return generateUnaryToF32IntervalCases(inputs, [exp2Interval]);
  },
});
