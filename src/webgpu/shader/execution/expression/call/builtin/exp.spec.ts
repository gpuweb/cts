...
import { expInterval, expLargestIntermediateValue } from '../../../../../util/f32_interval.js';
...
export const d = makeCaseCache('exp', {
  f32_const: () => {
    return generateUnaryToF32IntervalCases(inputs, [expInterval], expLargestIntermediateValue);
  },
  f32_non_const: () => {
    return generateUnaryToF32IntervalCases(inputs, [expInterval]);
  },
});
